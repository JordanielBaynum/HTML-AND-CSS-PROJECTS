...
//!When the user clicks this recipe button, open the modal//
...
document.getElementsById('contactForm').addEventListner('submit', function(event) {
    //!Overrides the default browser refresh when the submit button is pressed.//
    event.preventDefault();

    //!Variables to validate that each field is field out//
    ...
    if (!firstName || !lastName || !phone || !message) {
        //!Checks if fields have been field out.//
